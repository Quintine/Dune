...
export const RULE_TOPICS: RuleTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Normal Mentat questioning, Bureaucrat payments, special Sandmaster relocation and Smuggler battle collection, Spice Banker normal income and Diplomat retreat remain missing. Foreign gholas, Face Dancers and combined modules remain unfinished. This development prototype does not enable public module starts.',
